...
function StaySuite_User_Blog_Article() {
    const defaultAvatar =
    ...
    return (
        <section className="pt-28 pb-24 flex items-start flex-col mx-auto lg:container lg:max-w-[728px] space-y-8">
            ...
            {/* This is for Guest Users Portal */}
            <div className="w-full flex flex-row items-start space-x-4 pb-8">
                <Avatar className="h-10 w-10">
                    <AvatarImage src="https://substackcdn.com/image/fetch/w_32,h_32,c_fill,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack.com%2Fimg%2Favatars%2Fdefault-light.png" />
                    <AvatarFallback>CN</AvatarFallback>
                </Avatar>
                <div className="w-full space-y-4">
                    <Textarea id="" placeholder="Leave a comment" className="" />
...
export default StaySuite_User_Blog_Article;