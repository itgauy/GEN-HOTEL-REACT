    ...
    return (
        <section className="pt-28 pb-24 flex items-start flex-col mx-auto lg:container space-y-8">
            <div id="landing-banner" className="space-y-3">
                ...
                <div id="landing-text">
                    <span className="block lg:text-8xl font-extrabold max-w-[840px] break-words tracking-tight leading-none">Explore useful tips.</span>
                </div>
            </div>
            <div className="pt-20 w-full grid grid-cols-2 gap-6 mb-12">
                <div className="border border-slate-500 hover:bg-gray-100 rounded-xl p-5">
                    <a href="/user/onboard/blog/story">
                        <div className="leading-8 space-y-4">
                            <div id="article-hero">
                                <img src="https://qby900ozue.ufs.sh/f/k3CYx7aMjR9SRc9kNMsCiv4UJh150yGOZYWxesQwoIFAl8km" className="aspect-video w-full h-[240px] rounded-xl object-cover select-none" alt="" />
                            </div>
                            <div id="article-topic" className="space-y-2">
                                ...
                                <span className="text-xl font-bold line-clamp-3">
                                    Hotel Innovation: The value-curve approach to redefine hospitality and outshine competitors.
                                </span>
...
export default StaySuite_User_Blogs;